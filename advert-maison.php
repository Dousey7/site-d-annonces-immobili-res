...
<div class="page-title" style="background-image: url(dist/images/page-title.jpg);">
    ...
    <br>
        <div class="large-title text-center">        
            <h2><u>Toutes les Maisons et Villas :</u></h2>
        </div>
    <br>
    <br>
</div>
...
<div class="container" style="background-color: darksalmon;">
    <div class="row">
        <?php
            $req = $db->prepare("SELECT id, titre, description, auteur_id, image_url, localisation, statut, DATE_FORMAT(date_creation, '%d/%m/%Y à %H:%i:%S') AS date_creation_format FROM annonce WHERE titre = 'maison' OR titre = 'villa' ORDER BY date_creation DESC");
            $req->execute();
